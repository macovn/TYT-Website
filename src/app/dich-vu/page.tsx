...
const services = [
  {
    ...
    desc: "Khám và điều trị các bệnh thông thường, cấp phát thuốc BHYT cho người dân trong xã. Bác sĩ thực hiện thăm khám, chẩn đoán, kê đơn thuốc và theo dõi điều trị. Người có thẻ BHYT được khám hoặc giảm chi phí theo quy định.",
    schedule: "T2–T6: 7:30–11:30 và 13:30–16:30"
  },
  {
    name: "Tiêm chủng mở rộng",
    icon: <Syringe className="w-8 h-8" />,
    desc: "Tiêm chủng đầy đủ các loại vaccine trong chương trình tiêm chủng mở rộng quốc gia cho trẻ em từ 0–24 tháng và phụ nữ có thai. Đăng ký trước ngày tiêm để được sắp xếp lịch hợp lý.",

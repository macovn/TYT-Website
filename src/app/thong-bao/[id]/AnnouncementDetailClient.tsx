      ...
      <section className="bg-white border-b border-gray-100 pt-12 pb-8">
        <div className="container">
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap items-center gap-6 border-t border-gray-100 pt-8">
              <ShareButtons />
              <button 
                onClick={() => window.print()}
                className="flex items-center gap-2 text-gray-600 hover:text-[var(--primary)] font-medium transition-colors cursor-pointer"
              >
                <Printer size={18} />
                In thông báo
              </button>
